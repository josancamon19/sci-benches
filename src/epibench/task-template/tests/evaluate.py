...
CONFIG_PATH = Path("/tests/fallback_grader.json")
...
def grade() -> tuple[dict[str, Any], Path | None]:
    ...
    try:
        ...
        return grade_submission(config, submission), submission_path
