...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Export the public LatchBio TxBench-PP evaluations into Harbor format."
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("datasets/txbench-pp"),
        help="Generated Harbor dataset directory (default: datasets/txbench-pp).",
    )
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=None,
        help="Generate only the listed public TxBench-PP eval IDs.",
    )
    parser.add_argument(
        "--overwrite",
        action="store_true",
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Use a local TxBench-PP checkout instead of downloading eval definitions.",
    )
    parser.add_argument(
        "--source-cache-dir",
        type=Path,
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Optional Latch CLI executable; otherwise use pinned "
            f"latch {LATCH_CLI_VERSION} through uvx."
        ),
    )
    parser.add_argument(
        "--env-file",
